...
urlpatterns = patterns('',
    ...
    url(r'^recommand/(?P<api_key>.+)/$',        'apps.web.dashboard.views.recommand', name='dashboard-recommand'),
    ...
    url(r'^ajax/recommand_list$',           'apps.web.dashboard.views.ajax_recommand_list'),
    url(r'^ajax/update_recommand_list$',    'apps.web.dashboard.views.ajax_update_recommand_list'),
